      ...
      <div className='relative pt-4'>
        ...
        <div>
          ...
          <div className='mb-4 text-center text-xs font-normal text-gray-700'>
            <div>© Copyright {dayjs().year()} Minha IA.</div>
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ? <Link href={'#'} target='_blank' rel='noopener noreferrer'></Link>
                  : <>
                    <Link href='https://minhaia.com/privacidade' target='_blank' rel='noopener noreferrer'>Política de Privacidade</Link>,<span> </span>
                    <Link href='https://minhaia.com/termos' target='_blank' rel='noopener noreferrer'>Termos de Uso</Link>
                  </>
              }
            </div>
          </div>
