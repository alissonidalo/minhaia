const translation = {
  createApp: 'RECRUTAR FUNCIONÁRIO',
  types: {
    all: 'Todos',
    chatbot: 'Chatbot',
    agent: 'Agente',
  ...
  importFromDSL: 'Importar DSL',
  importFromDSLFile: 'Arquivo DSL',
  importFromDSLUrl: 'URL do Arquivo',
  ...
  newApp: {
    startFromBlank: 'Novo recrutamento',
    startFromTemplate: 'Recrutar a partir de modelo',
